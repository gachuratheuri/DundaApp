defmodule Dunda.Checkout.PaymentLineItem do
  ...
  def changeset(line, attrs) do
    line
    |> cast(attrs, [:payment_intent_id, :line_number, :ticket_tier_id, :quantity, :unit_price_cents, :currency, :price_version])
    |> validate_required([:payment_intent_id, :line_number, :quantity, :unit_price_cents, :currency, :price_version])
    ...
    |> unique_constraint([:payment_intent_id, :line_number], name: :payment_line_items_intent_line_unique)
  end
end
